    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 col-xl-4">
                ...
                <div class="detail-value"><?= esc($row->no_nota ?? '-') ?></div>
            </div>

            <div class="col-md-6 col-xl-4">
                <div class="detail-label">File Nota</div>
                <div class="detail-value">
                    <?php if (!empty($row->file_nota)): ?>
                        <a target="_blank" href="<?= esc(base_url((string) $row->file_nota)) ?>" class="btn btn-sm btn-outline-primary">Lihat Nota</a>
                    <?php else: ?>
                        -
                    <?php endif; ?>
                </div>
                    ...
                    <?php if ($detail_rows->count() > 0): ?>
                        ...
                        <?php foreach ($detail_rows as $d): ?>
                            <tr>
                                ...
                                <td><?= esc($d->kode_jenis_transaksi_template ?? '-') ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">Detail biaya produksi belum ada.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
