...
function kode_template_biaya_produksi(string $jenis): string
{
    $map = [
...
foreach ($jenis_detail as $i => $jenis) {
    ...
    $kode_template = $kode_template_pilihan !== '' ? $kode_template_pilihan : kode_template_biaya_produksi($jenis);
...
try {
    ...
    Capsule::connection()->transaction(function () use (
        ...
        $file_nota = upload_nota_biaya_produksi_file();
