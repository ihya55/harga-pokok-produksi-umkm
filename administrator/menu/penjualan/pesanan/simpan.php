...
try {
    ...
    Capsule::connection()->transaction(function () use (
        ...
        $no_pesanan = penjualan_generate_no_pesanan($id_entitas);

        $id_pesanan = (int) Capsule::table('tb_pesanan_penjualan')->insertGetId([
            'id_entitas' => $id_entitas,
            'no_pesanan_penjualan' => $no_pesanan,
        ...
        foreach ($detail_valid as $d) {
            Capsule::table('tb_pesanan_penjualan_detail')->insert([
                'id_pesanan_penjualan' => $id_pesanan,
        ...
        $id_pesanan_baru = $id_pesanan;
    });

    set_flash('success', 'Pesanan penjualan berhasil disimpan.');
    penjualan_redirect(admin_page_url('penjualan/pesanan/detail') . '&id=' . $id_pesanan_baru);
} catch (Throwable $e) {
    set_flash('error', 'Gagal menyimpan pesanan penjualan: ' . $e->getMessage());
    penjualan_redirect(admin_page_url('penjualan/pesanan/tambah'));
}